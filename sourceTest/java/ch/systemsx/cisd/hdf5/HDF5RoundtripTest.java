...
public class HDF5RoundtripTest
{
    ...
    public void testCreateSomeDeepGroup()
    {
        ...
        final IHDF5Writer writer = HDF5Factory.configure(datasetFile).writer();
    ...
    public void testScalarValues()
    {
        ...
        writer.close();
        final IHDF5Reader reader = HDF5Factory.configureForReading(datasetFile).reader();
    ...
    public void testScaleOffsetFilterInt()
    {
        ...
        final IHDF5Writer writer2 =
                HDF5Factory.configure(new File(workingDirectory,
    ...
    public void testDataSetsNonExtendable()
    {
        ...
        final IHDF5Writer writer =
                HDF5Factory.configure(datasetFile).dontUseExtendableDataTypes().syncMode(
    ...
    public void testOverwriteContiguousDataSet()
    {
        ...
        writer.close();
        writer = HDF5Factory.configure(datasetFile).writer();
        ...
        writer.close();
        IHDF5Reader reader = HDF5Factory.configureForReading(datasetFile).reader();
    ...
    public void testExtendCompactDataset()
    {
        ...
        long[] data = new long[]
            { 1, 2, 3 };
        IHDF5Writer writer = HDF5Factory.configure(datasetFile).writer();
        ...
        writer.writeLongArray(dsName, data);
        writer.close();
        reader = HDF5Factory.configureForReading(datasetFile).reader();
        assertTrue(Arrays.equals(data, reader.readLongArray(dsName)));
        reader.close();
    }
    ...
    public void testStringArray()
    {
        ...
        final IHDF5Writer writer = HDF5Factory.configure(stringArrayFile).writer();
        final String[] data = new String[]
            { "abc", "ABCxxx", "xyz" };
        final String dataSetName = "/aStringArray";
        writer.writeStringArray(dataSetName, data);
        writer.close();
        final IHDF5Reader reader = HDF5Factory.configureForReading(stringArrayFile).reader();
    ...
    public void testStringCompression()
    {
        ...
        final IHDF5Writer writer = HDF5Factory.configure(compressedStringFile).writer();
        ...
        writer.close();
        final IHDF5Reader reader = HDF5Factory.configureForReading(compressedStringFile).reader();
    ...
    public void testStringArrayCompression()
    {
        ...
        final IHDF5Writer writer = HDF5Factory.configure(compressedStringArrayFile).writer();
        final int size = 100000;
        final String longMonotonousString = StringUtils.repeat("a", size);
        final String[] data = new String[]
        ...
        writer.close();
        final IHDF5Reader reader = HDF5Factory.configureForReading(compressedStringArrayFile).reader();
        final String[] dataStored = reader.readStringArray(dataSetName);
        assertTrue(Arrays.equals(data, dataStored));
        reader.close();
    ...
    public void testGroups()
    {
        ...
        final IHDF5Writer writer = HDF5Factory.configure(groupFile).writer();
        ...
        writer.close();
        final IHDF5Reader reader = HDF5Factory.configureForReading(groupFile).reader();
    ...
    public void testGetDataSetInformation()
    {
        ...
        writer.close();
        final IHDF5Reader reader = HDF5Factory.configureForReading(file).reader();
    ...
    public void testHardLink()
    {
        ...
        final IHDF5Writer writer = HDF5Factory.configure(linkFile).writer();
        final String str = "BlaBlub";
        writer.writeString("/data/set", str);
        writer.createHardLink("/data/set", "/data/link");
        writer.close();
        final IHDF5Reader reader = HDF5Factory.configureForReading(linkFile).reader();
    ...
    public void testNullOnGetSymbolicLinkTargetForNoLink()
    {
        ...
        final IHDF5Writer writer = HDF5Factory.configure(noLinkFile).writer();
        writer.writeBoolean("/data/set", true);
        writer.close();
        final IHDF5Reader reader = HDF5Factory.configureForReading(noLinkFile).reader();
        try
        {
    ...
    public void testExternalLink()
    {
        ...
        final IHDF5Writer writer1 = HDF5Factory.configure(fileToLinkTo).writer();
        ...
        assertFalse(linkFile.exists());
        linkFile.deleteOnExit();
        final IHDF5Writer writer2 = HDF5Factory.configure(linkFile).writer();
    ...
    public void testEnum()
    {
        ...
        reader.close();
        final IHDF5Writer writer2 = HDF5Factory.configure(file).writer();
    ...
    public void testConfusedEnum()
    {
        ...
        try
        {
            writer = HDF5Factory.configure(file).writer();
    ...
    public void testNumericConversion()
    {
        ...
        final HDF5ReaderConfigurator config =
                HDF5Factory.configureForReading(file).performNumericConversions();
