...
public class HDF5RoundtripTest
{
    ...
    public void testOverwriteContiguousDataSet()
    {
        ...
        writer.close();
        HDF5Reader reader = new HDF5ReaderConfigurator(datasetFile).reader();
    ...
    public void testExtendCompactDataset()
    {
        ...
        long[] data = new long[]
            { 1, 2, 3 };
        HDF5Writer writer = new HDF5WriterConfigurator(datasetFile).writer();
    ...
    public void testStringArray()
    {
        ...
        final HDF5Writer writer = new HDF5WriterConfigurator(stringArrayFile).writer();
        final String[] data = new String[]
            { "abc", "ABCxxx", "xyz" };
        final String dataSetName = "/aStringArray";
        writer.writeStringArray(dataSetName, data);
        writer.close();
        final HDF5Reader reader = new HDF5ReaderConfigurator(stringArrayFile).reader();
    ...
    public void testStringCompression()
    {
        ...
        final HDF5Writer writer = new HDF5WriterConfigurator(compressedStringFile).writer();
    ...
    public void testStringArrayCompression()
    {
        ...
        final HDF5Writer writer = new HDF5WriterConfigurator(compressedStringArrayFile).writer();
        final int size = 100000;
        final String longMonotonousString = StringUtils.repeat("a", size);
        final String[] data = new String[]
    ...
    public void testGroups()
    {
        ...
        final HDF5Writer writer = new HDF5WriterConfigurator(groupFile).writer();
        ...
        writer.close();
        final HDF5Reader reader = new HDF5ReaderConfigurator(groupFile).reader();
    ...
    public void testHardLink()
    {
        ...
        final HDF5Writer writer = new HDF5WriterConfigurator(linkFile).writer();
        final String str = "BlaBlub";
        writer.writeString("/data/set", str);
        writer.createHardLink("/data/set", "/data/link");
        writer.close();
        final HDF5Reader reader = new HDF5ReaderConfigurator(linkFile).reader();
    ...
    public void testNullOnGetSymbolicLinkTargetForNoLink()
    {
        ...
        final HDF5Writer writer = new HDF5WriterConfigurator(noLinkFile).writer();
        writer.writeBoolean("/data/set", true);
        writer.close();
        final HDF5Reader reader = new HDF5ReaderConfigurator(noLinkFile).reader();
        try
        {
    ...
    public void testExternalLink()
    {
        ...
        final HDF5Writer writer1 = new HDF5WriterConfigurator(fileToLinkTo).writer();
    ...
    public void testEnum()
    {
        ...
        reader.close();
        final HDF5Writer writer2 = new HDF5WriterConfigurator(file).writer();
    ...
    public void testConfusedEnum()
    {
        ...
        assertFalse(file.exists());
        file.deleteOnExit();
        HDF5Writer writer = new HDF5WriterConfigurator(file).writer();
