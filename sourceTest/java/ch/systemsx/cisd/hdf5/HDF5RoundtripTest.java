...
public class HDF5RoundtripTest
{
    ...
    public void testOverwriteContiguousDataSet()
    {
        ...
        writer.close();
        IHDF5Reader reader = new HDF5ReaderConfigurator(datasetFile).reader();
    ...
    public void testExtendCompactDataset()
    {
        ...
        long[] data = new long[]
            { 1, 2, 3 };
        IHDF5Writer writer = new HDF5WriterConfigurator(datasetFile).writer();
        ...
        writer.writeLongArray(dsName, data);
        writer.close();
        reader = new HDF5ReaderConfigurator(datasetFile).reader();
        assertTrue(Arrays.equals(data, reader.readLongArray(dsName)));
        reader.close();
    }
    ...
    public void testStringArray()
    {
        ...
        final IHDF5Writer writer = new HDF5WriterConfigurator(stringArrayFile).writer();
        final String[] data = new String[]
            { "abc", "ABCxxx", "xyz" };
        final String dataSetName = "/aStringArray";
        writer.writeStringArray(dataSetName, data);
        writer.close();
        final IHDF5Reader reader = new HDF5ReaderConfigurator(stringArrayFile).reader();
    ...
    public void testStringCompression()
    {
        ...
        final IHDF5Writer writer = new HDF5WriterConfigurator(compressedStringFile).writer();
        ...
        writer.close();
        final IHDF5Reader reader = new HDF5ReaderConfigurator(compressedStringFile).reader();
    ...
    public void testStringArrayCompression()
    {
        ...
        final IHDF5Writer writer = new HDF5WriterConfigurator(compressedStringArrayFile).writer();
        final int size = 100000;
        final String longMonotonousString = StringUtils.repeat("a", size);
        final String[] data = new String[]
        ...
        writer.close();
        final IHDF5Reader reader = new HDF5ReaderConfigurator(compressedStringArrayFile).reader();
        final String[] dataStored = reader.readStringArray(dataSetName);
        assertTrue(Arrays.equals(data, dataStored));
        reader.close();
    ...
    public void testCreateDataTypes()
    {
        ...
        file.deleteOnExit();
        final IHDF5Writer writer = new HDF5WriterConfigurator(file).writer();
        try
        {
    ...
    public void testGroups()
    {
        ...
        final IHDF5Writer writer = new HDF5WriterConfigurator(groupFile).writer();
        ...
        writer.close();
        final IHDF5Reader reader = new HDF5ReaderConfigurator(groupFile).reader();
    ...
    public void testGetDataSetInformation()
    {
        ...
        writer.close();
        final IHDF5Reader reader = new HDF5ReaderConfigurator(file).reader();
    ...
    public void testHardLink()
    {
        ...
        final IHDF5Writer writer = new HDF5WriterConfigurator(linkFile).writer();
        final String str = "BlaBlub";
        writer.writeString("/data/set", str);
        writer.createHardLink("/data/set", "/data/link");
        writer.close();
        final IHDF5Reader reader = new HDF5ReaderConfigurator(linkFile).reader();
    ...
    public void testNullOnGetSymbolicLinkTargetForNoLink()
    {
        ...
        final IHDF5Writer writer = new HDF5WriterConfigurator(noLinkFile).writer();
        writer.writeBoolean("/data/set", true);
        writer.close();
        final IHDF5Reader reader = new HDF5ReaderConfigurator(noLinkFile).reader();
        try
        {
    ...
    public void testExternalLink()
    {
        ...
        final IHDF5Writer writer1 = new HDF5WriterConfigurator(fileToLinkTo).writer();
        ...
        assertFalse(linkFile.exists());
        linkFile.deleteOnExit();
        final IHDF5Writer writer2 = new HDF5WriterConfigurator(linkFile).writer();
    ...
    public void testEnum()
    {
        ...
        reader.close();
        final IHDF5Writer writer2 = new HDF5WriterConfigurator(file).writer();
    ...
    public void testConfusedEnum()
    {
        ...
        assertFalse(file.exists());
        file.deleteOnExit();
        IHDF5Writer writer = new HDF5WriterConfigurator(file).writer();
        ...
        try
        {
            writer = new HDF5WriterConfigurator(file).writer();
