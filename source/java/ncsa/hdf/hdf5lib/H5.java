...
public class H5 {
   ...
   */
    ...
    public synchronized static int H5Gget_obj_info_all(int loc_id, String name,
        ...
        return H5Gget_obj_info_all(loc_id, name, oname, otype, new int[oname.length], new long[oname.length], oname.length, HDF5Constants.H5_INDEX_NAME);
    }
