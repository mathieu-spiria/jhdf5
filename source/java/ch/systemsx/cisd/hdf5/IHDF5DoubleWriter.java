...
interface IHDF5DoubleWriter
{
    ...
    /**
     * Creates a <code>double</code> array (of rank 1). Uses a compact storage layout. Should only be
    ...
    /**
     * Writes out a <code>double</code> array (of rank 1). Uses a compact storage layout. Should only
    ...
    /**
     * Writes out a block of a <code>double</code> array (of rank 1). The data set needs to have been
     * created by {@link #createDoubleArray(String, long, int, boolean)} beforehand.
     * <p>
     ...
     * created by {@link #createDoubleArray(String, long, int, boolean)} beforehand.
     * <p>
     * Use this method instead of {@link #writeDoubleArrayBlock(String, double[], long)} if the total
     ...
     * @param deflate If <code>true</code>, the data set will be compressed.
     */
    public void writeDoubleMatrix(final String objectPath, final double[][] data, final boolean deflate);
