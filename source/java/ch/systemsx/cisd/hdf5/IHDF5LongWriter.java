...
interface IHDF5LongWriter
{
     ...
     */
    public void createLongArrayCompact(final String objectPath, final long size);
    ...
    /**
     * Creates a <code>long</code> array (of rank 1). The initial size of the array is 0.
     * 
     * @param objectPath The name (including path information) of the data set object in the file.
    ...
    /**
     * Creates a multi-dimensional <code>long</code> array. The initial size of the array is 0.
     * 
     * @param objectPath The name (including path information) of the data set object in the file.
