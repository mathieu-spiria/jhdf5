...
public interface IHDF5OpaqueWriter
{
     ...
     * {@link IHDF5GenericReader#readAsByteArray(String)} instead.
     * 
     ...
     * <p>
     * Note that there is no dedicated method for reading opaque types. Use the method
     * {@link IHDF5GenericReader#readAsByteArrayBlock(String, int, long)} instead.
     * 
     * @param objectPath The name (including path information) of the data set object in the file.
     ...
     * <p>
     * Note that there is no dedicated method for reading opaque types. Use the method
     * {@link IHDF5GenericReader#readAsByteArrayBlockWithOffset(String, int, long)} instead.
     * 
     * @param objectPath The name (including path information) of the data set object in the file.
     * @param data The data to write. The length defines the block size. Must not be
     *            <code>null</code> or of length 0.
