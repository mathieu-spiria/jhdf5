...
class HDF5IntReader implements IHDF5IntReader
{
    ...
    public long[] readToIntMDArrayWithOffset(final String objectPath, final MDIntArray array,
    ...
    public long[] readToIntMDArrayBlockWithOffset(final String objectPath,
