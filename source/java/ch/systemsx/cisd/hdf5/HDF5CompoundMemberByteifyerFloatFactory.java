 ...
 * @author Bernd Rinn
 */
public class HDF5CompoundMemberByteifyerFloatFactory implements IHDF5CompoundMemberBytifyerFactory
{
            ...
            final Rank rank)
    {
        ...
        return new HDF5MemberByteifyer(field, memberName, FLOAT_SIZE * len, offset)
            {
                @Override
    ...
    {
        return new HDF5MemberByteifyer(null, memberName, FLOAT_SIZE * len, offset)
            {
                @Override
                protected int getMemberStorageTypeId()
                {
