...
class HDF5DoubleWriter implements IHDF5DoubleWriter
{
    ...
    public void setDoubleAttribute(final String objectPath, final String name, final double value)
    {
        ...
        baseWriter.setAttribute(objectPath, name, H5T_IEEE_F64LE, H5T_NATIVE_DOUBLE, new double[]
            { value });
    }
        ...
        final ICallableWithCleanUp<Void> setAttributeRunnable = new ICallableWithCleanUp<Void>()
            {
                public Void call(ICleanUpRegistry registry)
                {
                    final int memoryTypeId =
                            baseWriter.h5
                                    .createArrayType(H5T_NATIVE_DOUBLE, value.length, registry);
        ...
        final ICallableWithCleanUp<Void> writeRunnable = new ICallableWithCleanUp<Void>()
            {
                public Void call(ICleanUpRegistry registry)
                {
                    ...
                    H5Dwrite(dataSetId, H5T_NATIVE_DOUBLE, memorySpaceId, dataSpaceId, H5P_DEFAULT,
                            data);
                    return null; // Nothing to return.
                }
            };
