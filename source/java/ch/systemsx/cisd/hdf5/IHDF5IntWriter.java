...
public interface IHDF5IntWriter extends IHDF5IntReader
{
    ...
    /**
     * Creates a <code>int</code> array (of rank 1) and opens it for reading and writing.
     * 
     * @param objectPath The name (including path information) of the data set object in the file.
     * @param size When the writer is configured to use extendable data types (see
     *            {@link IHDF5WriterConfigurator#dontUseExtendableDataTypes()}), the initial size
    ...
    /**
     * Creates a <code>int</code> array (of rank 1). When creating many data sets with the same
     * features, this method will be faster than
     ...
     * beforehand.
     * <p>
     * <i>This method is faster than {@link #writeArrayBlock(String, int[], long)} 
     ...
     * @param blockNumber The number of the block to write.
     */
    public void writeArrayBlock(HDF5DataSet dataSet, int[] data,
            long blockNumber);
     ...
     * beforehand.
     * <p>
     * Use this method instead of {@link #writeArrayBlock(HDF5DataSet, int[], long)} if the
     * total size of the data set is not a multiple of the block size.
     * <p>
     * <i>This method is faster than {@link #writeArrayBlockWithOffset(String, int[], int, long)} 
     * when called many times on the same data set.</i>
     * 
     * @param dataSet The data set to write to.
     * @param data The data to write. The length defines the block size. Must not be
     ...
     * @return The created data set.
     */
    public void writeMDArrayBlock(HDF5DataSet dataset, MDIntArray data,
            long[] blockNumber);
     ...
     * @param offset The offset in the data set  to start writing to in each dimension.
     */
    public void writeMDArrayBlockWithOffset(HDF5DataSet dataSet, MDIntArray data,
            long[] offset);
