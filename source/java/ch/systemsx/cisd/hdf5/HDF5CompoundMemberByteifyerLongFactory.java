 ...
 * @author Bernd Rinn
 */
public class HDF5CompoundMemberByteifyerLongFactory implements IHDF5CompoundMemberBytifyerFactory
{
            ...
            final Rank rank)
    {
        ...
        return new HDF5MemberByteifyer(field, memberName, LONG_SIZE * len, offset)
            {
                @Override
    ...
    {
        return new HDF5MemberByteifyer(null, memberName, LONG_SIZE * len, offset)
            {
                @Override
                protected int getMemberStorageTypeId()
                {
